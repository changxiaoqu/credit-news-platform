...
const initialData = [
    ...
    // ========== 商机信息 ==========
    {title: '场景金融：信用卡业务从"发卡"转向"场景获客"', summary: '随着信用卡新规实施，银行信用卡业务正从传统的跑马圈地转向场景化、精细化运营。场景金融成为信用卡获客和活客的核心抓手，包括线下商超、餐饮、文旅、出行等高频消费场景。县域下沉成为新增长点，三四线城市及农村市场信用卡渗透率提升空间巨大。', source: '行业研究', url: 'https://credit-news-platform-production-6acb.up.railway.app/', category: 'business', tags: '["商机","场景金融"]', publish_date: '2026-04-01'},
    {title: '数字化创新：AI+大数据赋能信用卡风控与营销', summary: '信用卡行业数字化转型加速，AI大模型、大数据风控、智能营销成为竞争焦点。银行加大对信用卡数字化渠道的投入，通过精准营销提升获客效率。智能风控、实时交易监测、反欺诈识别成为技术应用重点方向。', source: '行业研究', url: 'https://credit-news-platform-production-6acb.up.railway.app/', category: 'business', tags: '["商机","数字化"]', publish_date: '2026-04-01'},
    {title: '不良资产处置：信用卡不良资产批量转让市场升温', summary: '随着信用卡不良率攀升，银行加速通过批量转让方式出清信用卡不良资产。2026年1月，个人不良贷款批量转让市场持续升温，持牌消费金融公司在银登中心挂牌转让个人消费贷不良资产包超110亿元。信用卡不良资产转让成为银行出清风险的常规渠道。', source: '银登中心', url: 'https://www.nfra.gov.cn/', category: 'business', tags: '["商机","不良资产"]', publish_date: '2026-04-01'},
