...
const initialData = [
    // ========== 商机信息 (business) ★新增 ==========
    {title: '苏州银行信用卡智能风控系统升级项目启动需求调研', summary: '苏州银行信用卡部计划对现有风控系统进行智能化升级，重点方向包括实时交易反欺诈模型、信用卡额度动态调整引擎、异常行为识别等，预算区间500-800万元，预计下半年启动招标，正在对接潜在技术供应商。', source: '苏州银行', url: 'https://www.szbchina.com/bid2026/suzhou', category: 'business', tags: '["智能风控","信用卡","系统升级"]', publish_date: '2026-04-18'},
    {title: '宁波银行寻求信用卡分期业务场景合作方', summary: '宁波银行信用卡中心公开征集优质消费场景合作方，要求合作方具备线上分期获客和运营能力，合作模式为联合运营或导流分成，重点合作领域包括3C数码、家电、医美、教育分期。', source: '宁波银行', url: 'https://www.ningbank.com/bid2026/nb', category: 'business', tags: '["场景金融","分期合作","联合运营"]', publish_date: '2026-04-15'},
    {title: '江南农商行信用卡数字化运营平台采购需求', summary: '江南农村商业银行计划采购一套信用卡数字化运营平台，涵盖客户生命周期管理、营销自动化、权益运营、数据分析等模块，预算350万元，要求具备农信体系实施经验。', source: '江南农商行', url: 'https://www.jnrcbank.com/bid2026', category: 'business', tags: '["数字化运营","信用卡","采购"]', publish_date: '2026-04-12'},
    {title: '常熟农商行启动信用卡业务AI外呼系统建设项目', summary: '常熟农村商业银行信用卡业务部规划建设AI智能外呼系统，用于客户激活、账单提醒、分期营销、逾期提醒等场景，预计采购20-30路并发线路，预算80-120万元。', source: '常熟农商行', url: 'https://www.csrcbank.com/bid2026', category: 'business', tags: '["AI外呼","信用卡","智能营销"]', publish_date: '2026-04-10'},
    {title: '杭州银行信用卡客户标签体系建设技术合作招募', summary: '杭州银行信用卡中心寻求第三方数据科技公司合作，共同构建信用卡客户标签体系，合作内容包括行为数据采集、标签建模、人群画像输出，需具备金融行业标签体系建设经验。', source: '杭州银行', url: 'https://www.hzbank.com.cn/bid2026', category: 'business', tags: '["客户标签","数据合作","精准营销"]', publish_date: '2026-04-08'},
    {title: '上海农商行信用卡大数据反欺诈平台二期建设项目', summary: '上海农村商业银行已启动信用卡大数据反欺诈平台二期建设规划，重点增加机器学习实时决策引擎、跨行黑名单共享、异常网络关联分析等能力，预算600万元，正在进行需求细化。', source: '上海农商行', url: 'https://www.shrcb.com/bid2026', category: 'business', tags: '["反欺诈","大数据","信用卡"]', publish_date: '2026-04-05'},
    {title: '张家港农商行信用卡场景分期合作项目招标', summary: '张家港农村商业银行信用卡部征集场景分期合作机构，重点招募家居建材、教育培训、出行旅游等消费场景的运营服务商合作，要求具备独立风控能力和场景运营经验。', source: '张家港农商行', url: 'https://www.zjgbank.com/bid2026', category: 'business', tags: '["场景分期","合作招募","信用卡"]', publish_date: '2026-04-03'},
    {title: '徽商银行信用卡智能审批系统升级改造需求', summary: '徽商银行信用卡中心计划对现有审批系统进行AI智能化改造，引入NLP预审模型、自动化的件分配策略、欺诈关联图谱等，预算280万元，要求供应商具备银行信用卡审批系统实施案例。', source: '徽商银行', url: 'https://www.hsbank.com.cn/bid2026', category: 'business', tags: '["智能审批","信用卡","系统升级"]', publish_date: '2026-04-01'},
    {title: '深圳农商行信用卡全渠道智能客服系统采购', summary: '深圳农村商业银行信用卡中心计划采购全渠道智能客服系统，支持微信、APP、电话、短信等多渠道接入，要求集成大模型文本机器人和语音导航，预算220万元。', source: '深圳农商行', url: 'https://www.40000.gov.cn/bid2026', category: 'business', tags: '["智能客服","全渠道","信用卡"]', publish_date: '2026-03-28'},
    {title: '重庆农商行信用卡不良资产数字化催收平台建设', summary: '重庆农村商业银行拟建设数字化催收管理平台，实现催收任务智能分配、催记语音转写、催收效能分析等功能，采购预算150万元，要求具备银行催收系统建设经验。', source: '重庆农商行', url: 'https://www.cqrcb.com/bid2026', category: 'business', tags: '["数字化催收","信用卡","不良资产"]', publish_date: '2026-03-25'},
    {title: '长沙银行信用卡权益平台运营服务采购', summary: '长沙银行信用卡中心采购权益运营服务，要求合作方具备聚合权益平台搭建能力，覆盖美食、出行、影音、商超等场景，预算100万元/年，合作期两年。', source: '长沙银行', url: 'https://www BANKOFCHANGSHA.com.cn/bid2026', category: 'business', tags: '["权益运营","信用卡","服务采购"]', publish_date: '2026-03-22'},
    {title: '贵阳银行信用卡业务数字化转型战略咨询项目', summary: '贵阳银行信用卡业务部启动数字化转型战略规划咨询项目采购，寻求专业咨询公司协助制定未来3年信用卡业务数字化路线图，预算80万元。', source: '贵阳银行', url: 'https://www.gybank.com/bid2026', category: 'business', tags: '["数字化转型","战略咨询","信用卡"]', publish_date: '2026-03-18'},
    {title: '青岛银行信用卡积分兑换平台升级改造需求', summary: '青岛银行信用卡中心计划对现有积分兑换平台进行升级，增加积分实时兑换、第三方权益融合、积分商城智能推荐等功能，预算120万元，要求支持私有化部署。', source: '青岛银行', url: 'https://www.qdccb.com/bid2026', category: 'business', tags: '["积分平台","信用卡","系统升级"]', publish_date: '2026-03-15'},
    {title: '北京农商行信用卡客户权益SaaS平台采购', summary: '北京农村商业银行信用卡部采购一套权益SaaS平台，用于整合各合作方权益资源，实现权益发放、核销、结算自动化，预算90万元/年，支持按需订阅模式。', source: '北京农商行', url: 'https://www.bjrcb.com/bid2026', category: 'business', tags: '["权益SaaS","信用卡","采购"]', publish_date: '2026-03-12'},
    {title: '成都银行信用卡账单分期业务联合运营招募', summary: '成都银行信用卡中心公开招募账单分期业务联合运营合作伙伴，要求合作方具备线上分期场景获客能力和资金垫付能力，采用联合建模、收益分成模式合作。', source: '成都银行', url: 'https://www.bankchengdu.com/bid2026', category: 'business', tags: '["分期联合运营","信用卡","场景合作"]', publish_date: '2026-03-08'},
    {title: '郑州银行信用卡交易监控数据分析服务采购', summary: '郑州银行信用卡部采购信用卡交易监控数据分析服务，重点需求包括异常交易模式识别、商户风险评级、伪冒交易预警等，预算60万元/年。', source: '郑州银行', url: 'https://www.zzbank.com/bid2026', category: 'business', tags: '["交易监控","数据分析","信用卡"]', publish_date: '2026-03-05'},
    {title: '广州农商行信用卡客群经营分析平台建设项目', summary: '广州农村商业银行计划建设信用卡客群经营分析平台，实现客户分层画像、价值评估、流失预警、营销响应预测等功能，预算200万元，要求具备银行客群分析系统建设经验。', source: '广州农商行', url: 'https://www.grcbank.com/bid2026', category: 'business', tags: '["客群分析","数据平台","信用卡"]', publish_date: '2026-03-01'},
    {title: '天津银行信用卡Ⅱ类户及信用贷款联合放款合作', summary: '天津银行信用卡中心寻求与头部互联网平台联合开展Ⅱ类户开卡及信用贷款合作，要求合作平台具备亿级用户规模和成熟的风控体系，采用资金联合出资、风险共担模式。', source: '天津银行', url: 'https://www.bankoftianjin.com.cn/bid2026', category: 'business', tags: '["联合放款","信用贷款","Ⅱ类户"]', publish_date: '2026-02-25'},
    {title: '吉林银行信用卡业务移动展业系统采购', summary: '吉林银行信用卡中心采购移动展业系统，支持客户经理手持设备完成进件采集、身份核验、电子签名、额度审批等全流程，预算150万元，要求适配鸿蒙系统。', source: '吉林银行', url: 'https://www.jlbank.com.cn/bid2026', category: 'business', tags: '["移动展业","信用卡","硬件采购"]', publish_date: '2026-02-20'},
    {title: '内蒙古银行信用卡数据分析团队外包服务采购', summary: '内蒙古银行信用卡业务部采购数据分析团队外包服务，要求合作方提供不少于5名专职数据分析师，负责日常经营分析、模型调优、报告输出，预算120万元/年。', source: '内蒙古银行', url: 'https://www.imBank.com/bid2026', category: 'business', tags: '["数据分析","外包服务","团队外包"]', publish_date: '2026-02-15'},
    {title: '厦门银行信用卡智能营销中台系统建设项目', summary: '厦门银行信用卡中心规划建设智能营销中台，整合客户触达、权益配置、活动管理、效果追踪等能力，实现营销活动全链路自动化，预算380万元。', source: '厦门银行', url: 'https://www.xmbank.com/bid2026', category: 'business', tags: '["营销中台","智能营销","信用卡"]', publish_date: '2026-02-10'},
    {title: '盛京银行信用卡业务信用卡APP升级改造采购', summary: '盛京银行信用卡中心计划对信用卡专属APP进行全面升级，改版UI设计、增加社交分享、积分互动、社区功能等，预算200万元。', source: '盛京银行', url: 'https://www.sjbank.com/bid2026', category: 'business', tags: '["APP升级","信用卡","移动端"]', publish_date: '2026-02-05'},
