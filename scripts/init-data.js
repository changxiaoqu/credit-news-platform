...
const initialData = [
    ...
    // ========== 监管政策 (policy) ==========
    {title: '三部门：个人消费贷款贴息政策延至2026年底，信用卡账单分期纳入支持范围', summary: '财政部、中国人民银行、金融监管总局联合发布通知，将个人消费贷款财政贴息政策实施期限延长至2026年12月31日，首次将信用卡账单分期业务纳入贴息支持范围，年贴息比例为1个百分点。取消单笔消费贴息500元上限，每名借款人每年累计贴息上限维持3000元，新增500多家经办机构。', source: '财政部/央行/金融监管总局', url: 'https://www.nfra.gov.cn', category: 'policy', tags: '["政策","消费贷款"]', publish_date: '2026-01-20', policy_no: '财金〔2026〕1号', issuing_authority: '财政部/中国人民银行/金融监管总局', effective_date: '2025-09-01', policy_level: '规范性文件', key_points: '信用卡账单分期纳入贴息范围，年贴息1%，取消单笔500元上限', is_key_policy: 1},
    {title: '《金融机构客户尽职调查和客户身份资料及交易记录保存管理办法》正式实施', summary: '2026年1月1日起，中国人民银行、国家金融监督管理总局、证监会三部门联合发布的《金融机构客户尽职调查和客户身份资料及交易记录保存管理办法》正式实施。将过去的"客户身份识别"升级为"客户尽职调查"，要求银行从静态的"核对身份证"转变为动态的"了解你的客户"，必须穿透识别受益所有人，并持续监测交易行为。', source: '央行/金融监管总局/证监会', url: 'https://www.pbc.gov.cn/', category: 'policy', tags: '["政策","反洗钱"]', publish_date: '2026-01-01', policy_no: '人行/金监/证监会令〔2025〕第3号', issuing_authority: '中国人民银行/国家金融监管总局/证监会', effective_date: '2026-01-01', policy_level: '部门规章', key_points: '客户身份识别升级为客户尽职调查，穿透识别受益所有人', is_key_policy: 0},
    {title: '信用卡个性化分期新规：2026年起不得强制要求提供担保人', summary: '国家金融监管总局发布《关于优化信用卡债务纾困机制的通知》，明确从2026年1月1日起，金融机构办理信用卡个性化分期业务时，不得强制要求持卡人提供担保人。招行、广发、平安等主流机构已全面取消担保人门槛。', source: '国家金融监督管理总局', url: 'https://www.nfra.gov.cn/credit-notice-2026', category: 'policy', tags: '["监管政策","信用卡协商","债务纾困"]', publish_date: '2026-01-01', policy_no: '金规〔2025〕XX号', issuing_authority: '国家金融监督管理总局', effective_date: '2026-01-01', policy_level: '规范性文件', key_points: '信用卡个性化分期不得强制要求提供担保人', is_key_policy: 1},
